            ...
            <div class="px-8 py-6">
                <ul class="divide-y divide-gray-200">
                    @foreach ($paymentMethods as $paymentMethod)
                        <li class="py-2 flex justify-between items-center" wire:key="{{ $paymentMethod->id }}">
                            <div>
                                <p>
                                    ...
                                    @if ($this->defaultPaymentMethod->id === $paymentMethod->id)
                                        <span class="ml-2 bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-blue-900 dark:text-blue-300">
                                            Predeterminado
                                        </span>
                                    @endif
                                </p>
